        ...
        child: isLoading
            ?  SizedBox(
                ...
                child: CircularProgressIndicator(
                  strokeWidth: 2,
                  valueColor: AlwaysStoppedAnimation<Color>(AppThemData.primaryBlack),
                ),
              )
            : Text(buttonTitle ?? "", style: TextStyle(fontFamily: AppThemeData.medium, fontSize: 16, color: textColor ?? AppThemData.primaryBlack), textAlign: TextAlign.center));
  }
}
