              ...
              child: MouseRegion(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Obx(() {
                      final bool isCabScreen = Get.currentRoute == Routes.CAB_BOOKING_SCREEN;
                      final controller = Get.isRegistered<CabBookingController>()
                          ? Get.find<CabBookingController>()
                          : Get.put(CabBookingController());
                      final String currentType = controller.selectedBookingType.value;
                      return Column(
                        children: [
                          ListItem(
                            ...
                            onPress: () {
                              ...
                              controller.changeBookingType('cab');
                              Get.toNamed(Routes.CAB_BOOKING_SCREEN);
                            },
                            isSelected: isCabScreen && currentType == 'cab',
                            themeChange: themeChange,
                          ),
                          ListItem(
                            buttonTitle: 'Shuttle Bookings'.tr,
                            icon: 'assets/icons/my_ride.svg',
                            onPress: () {
                              if (Get.currentRoute == Routes.CAB_DETAIL) {
                                Get.back();
                              }
                              controller.changeBookingType('bus');
                              Get.toNamed(Routes.CAB_BOOKING_SCREEN);
                            },
                            isSelected: isCabScreen && currentType == 'bus',
                            themeChange: themeChange,
                          ),
                          ListItem(
                            buttonTitle: 'Logistics Bookings'.tr,
                            icon: 'assets/icons/my_ride.svg',
                            onPress: () {
                              if (Get.currentRoute == Routes.CAB_DETAIL) {
                                Get.back();
                              }
                              controller.changeBookingType('truck');
                              Get.toNamed(Routes.CAB_BOOKING_SCREEN);
                            },
                            isSelected: isCabScreen && currentType == 'truck',
                            themeChange: themeChange,
                          ),
                          // ListItem(
                          //   buttonTitle: 'Pending Bookings'.tr,
                          //   icon: 'assets/icons/my_ride.svg',
                          //   onPress: () {
                          //     Get.toNamed(Routes.PENDING_BOOKINGS);
                          //   },
                          //   isSelected: Get.currentRoute == Routes.PENDING_BOOKINGS,
                          //   themeChange: themeChange,
                          // ),
                        ],
                      );
                    ...
                    ListTile(
                        title: TextCustom(
                      title: "USERS MANAGEMENT".tr,
                      fontSize: 12,
                      color: AppThemData.greyShade400,
                    )),
                    ListItem(
                      buttonTitle: "Users".tr,
                    ...
                    ListItem(
                      buttonTitle: "Role & Permissions".tr,
                      icon: "assets/icons/ic_user.svg",
                      onPress: () {
                        if (Get.currentRoute == Routes.CAB_DETAIL) {
                          Get.back();
                        }
                        Get.toNamed(Routes.ROLE_PERMISSIONS);
                      },
                      isSelected: Get.currentRoute == Routes.ROLE_PERMISSIONS,
                      themeChange: themeChange,
                    ),
                    ListTile(
                        title: TextCustom(
                    ...
                    ListItem(
                      ...
                      icon: "assets/icons/my_ride.svg",
                      buttonTitle: 'Vehicles'.tr,
                      isSelected: Get.currentRoute == Routes.VEHICLE,
                      themeChange: themeChange,
                    ),
