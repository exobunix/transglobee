...
import 'package:admin/app/modules/routes_setting/views/routes_setting_view.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

import 'package:admin/app/modules/setting_screen/views/widgets/pricing_setting_view.dart';
...
class SettingScreenController extends GetxController {
  ...
  final settingsAllPage = [
    ...
    SettingsItem(title: ['Ride Pricing & Surge'], icon: "assets/icons/ic_payment.svg", widget: [const PricingSettingView()], selectIndex: 0),
    SettingsItem(title: ['Add Routes'], icon: "assets/icons/my_ride.svg", widget: [const RoutesSettingView()], selectIndex: 0),
