                                      ...
                                      child: ClipRRect(
                                          ...
                                          child: controller.isLoading.value
                                            ...
                                            rows: controller.couponList
                                                .map((couponModel) =>
                                                DataRow(cells: [
                                                  DataCell(TextCustom(title: (couponModel.title ?? 'N/A').toString())),
                                                  DataCell(TextCustom(title: (couponModel.code ?? 'N/A').toString())),
                                                  DataCell(TextCustom(title: couponModel.expireAt != null ? Constant.timestampToDate(couponModel.expireAt!) : 'N/A')),
                                                  DataCell(
                                                    Transform.scale(
                                                      scale: 0.8,
                                                      child: CupertinoSwitch(
                                                        ...
                                                        onChanged: (value) async {
                                                          if (Constant.isDemo) {
                                                            ...
                                                            await controller.toggleCoupon(couponModel, value);
                                                          }
                                                        },
                                                      ),
                                                    ),
                                                  ...
                                                  DataCell(TextCustom(title: (couponModel.minAmount ?? '0').toString())),
                                                  DataCell(TextCustom(title: (couponModel.amount ?? '0').toString())),
                                                  DataCell(
                                                    Container(
                                                        ...
                                                        children: [
                                                          InkWell(
                                                            onTap: () {
                                                              ...
                                                              controller.isActive.value = couponModel.active ?? false;
                                                              ...
                                                              controller.expireDateController.value.text = couponModel.expireAt != null ? Constant.timestampToDate(couponModel.expireAt!) : "";
                    ...
                    onPress: () {
                      if (Constant.isDemo) {
                        ...
                        if (controller.couponTitleController.value.text.isNotEmpty &&
                          ...
                          controller.isEditing.value ? controller.updateCoupon() : controller.addCoupon(context);
                          controller.setDefaultData();
                          Navigator.pop(context);
                        } else {
