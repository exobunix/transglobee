                                        ...
                                        : DataTable(
                                            ...
                                            rows: controller.currentPageUser
                                                .map((userModel) => DataRow(cells: [
                                                      ...
                                                      DataCell(TextCustom(title: "${userModel.password}")),
                                                          ...
                                                          child: CupertinoSwitch(
                                                            ...
                                                            onChanged: (value) async {
                                                              if(Constant.isDemo){
                                                                ...
                                                                await controller.updateUserStatus(userModel, value);
                                                              }
                                                            },
                                                          ),
                                                        ),
                            ...
                            CustomButtonWidget(
                                ...
                                onPress: () async {
                                  if (Constant.isDemo) {
                                    ...
                                    bool isSaved = await controller.updateProfile(
                                      name: controller.userNameController.value.text,
                                      email: controller.emailController.value.text,
                                      phone: controller.phoneNumberController.value.text,
                                      gender: controller.userModel.value.gender ?? "",
                                    );
                                    if (isSaved) {
                                      await controller.assignRoutes(
                                        controller.userModel.value.id!,
                                        controller.selectedRouteIds,
                                      );
                                    }
                                    Get.back(); // close waitingLoader
                                    if (isSaved) {
