// ignore_for_file: body_might_complete_normally_catch_error, use_build_context_synchronously, unused_local_variable
...
class PayoutRequestController extends GetxController {
  ...
  Future<void> generatePayoutRequestDataPdf(List<WithdrawModel> payoutRequestList, DateTimeRange selectedRange) async {
    ...
    if (fileBytes != null) {
      downloadFile(fileBytes, 'Payout_Request_${formattedStartDate}_to_$formattedEndDate.xlsx');
    }
  }
}
