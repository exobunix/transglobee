...
class SubscriptionHistoryView extends GetView<SubscriptionHistoryController> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SubscriptionHistoryController>(
                                                ...
                                                child: DropdownSearch<DriverUserModel>(
                                                  ...
                                                  onChanged: (DriverUserModel? selectedItem) async {
                                                    ...
                                                    if (selectedItem.id == 'All') {
                                                      ...
                                                      await FireStoreUtils.countSubscriptionPlan(
                                                        'All',
                                                          ...
                                                          decoration: InputDecoration(
                                                            ...
                                                            focusedBorder: OutlineInputBorder(
                                                              ...
                                                              borderSide: BorderSide(
                                                                width: 0.5,
                                                                color:
                                                                    themeChange.isDarkTheme() ? AppThemData.greyShade950 : AppThemData.greyShade100,
                                                              ),
                                                            ),
                                                  ...
                                                  onPressed: () {
                                                    ...
                                                    showDialog(
                                                        ...
                                                        builder: (context) => CustomDialog(
                                                              controller: controller,
                                                              title: "Subscription History Download",
                                                              widgetList: [
                                                                const TextCustom(
                                                                  title: 'Select Time',
                                                                  fontFamily: AppThemeData.regular,
                                                                  ...
                                                                  child: Obx(
                                                                    () => DropdownButtonFormField(
                                                                      ...
                                                                      style: TextStyle(
                                                                        fontFamily: AppThemeData.medium,
                                                                        color:
                                                                            themeChange.isDarkTheme() ? AppThemData.textBlack : AppThemData.textGrey,
                                                                      ),
                                                                      ...
                                                                      : CustomButtonWidget(
                                                                          ...
                                                                          onPress: () {
                                                                            if (Constant.isDemo) {
                                                                              ...
                                                                              controller.downloadSubscriptionHistoryPdf(context);
                                                                            }
                                                                          },
                                                                        ),
                                                                )
                                                      ...
                                                      .map((subscriptionHistory) => DataRow(cells: [
                                                            DataCell(
                                                              Container(
                                                                  ...
                                                                  child: TextCustom(title: "#${subscriptionHistory.id!.substring(0, 8)}")),
                                                            ),
                                                            DataCell(
                                                              FutureBuilder<DriverUserModel?>(
                                                                  future: FireStoreUtils.getDriverByDriverID(
                                                                      subscriptionHistory.driverId.toString()), // async work
                                                              ...
                                                              Container(
                                                                  ...
                                                                  child: TextCustom(
                                                                      title: Constant.amountShow(
                                                                          amount: subscriptionHistory.subscriptionPlan!.price.toString()))),
                                                            ),
                                                            DataCell(
                                                              Container(
                                                                  padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 8),
                                                                  child: TextCustom(title: subscriptionHistory.paymentType.toString())),
                                                            ),
                                                            DataCell(
                                                              Container(
                                                                  padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 8),
                                                                  child: TextCustom(
                                                                    title: (subscriptionHistory.expiryDate == null ||
                                                                            subscriptionHistory.expiryDate!.toDate().isAfter(DateTime.now()))
                                                                        ? "Active"
                                                                        : "Expired",
                                                                    color: (subscriptionHistory.expiryDate == null ||
                                                                            subscriptionHistory.expiryDate!.toDate().isAfter(DateTime.now()))
                                                            ...
                                                            DataCell(
                                                              Container(
                                                                  padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 8),
                                                                  child: TextCustom(
                                                                      title: Constant.timestampToDateTime(subscriptionHistory.createdAt!))),
                                                            ),
                                                          ]))
                                                      .toList()),
                                            ),
