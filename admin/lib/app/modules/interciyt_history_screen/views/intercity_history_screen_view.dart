...
class InterCityHistoryScreenView extends GetView<InterCityHistoryScreenController> {
  const InterCityHistoryScreenView({super.key});

  @override
  Widget build(BuildContext context) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    return GetX<InterCityHistoryScreenController>(
      init: InterCityHistoryScreenController(),
      builder: (controller) {
        return Scaffold(
                                                    ...
                                                    child: DropdownSearch<DriverUserModel>(
                                                      ...
                                                      onChanged: (DriverUserModel? selectedItem) async {
                                                        ...
                                                        if (selectedItem.id == 'All') {
                                                          ...
                                                          await FireStoreUtils.countStatusWiseInterCity(
                                                            'All',
                                                          ...
                                                          searchFieldProps: TextFieldProps(
                                                              ...
                                                              decoration: InputDecoration(
                                                                ...
                                                                hintStyle: TextStyle(
                                                                  ...
                                                                  fontSize: 16,
                                                                  color:
                                                                      themeChange.isDarkTheme() ? AppThemData.greyShade500 : AppThemData.greyShade800,
                                                                ),
                                                      ...
                                                      decoratorProps:
                                                          DropDownDecoratorProps(decoration: defaultInputDecorationForSearchDropDown(context)),
                                                    ),
                                                  ),
                                                ),
                                                spaceW(),
                                                      ...
                                                      onPressed: () {
                                                        ...
                                                        showDialog(
                                                            ...
                                                            builder: (context) => CustomDialog(
                                                                  controller: controller,
                                                                  title: "Intercity History Download",
                                                                  // widgetList: [
                                                                  //   CustomTextFormField(
                                                                                    ...
                                                                                    searchFieldProps: TextFieldProps(
                                                                                        ...
                                                                                        decoration: InputDecoration(
                                                                                          ...
                                                                                          border: OutlineInputBorder(
                                                                                            borderRadius: BorderRadius.circular(10),
                                                                                            borderSide: BorderSide(
                                                                                                width: 0.5, color: AppThemData.primaryBlack),
                                                                                          ),
                                                                                          errorBorder: OutlineInputBorder(
                                                                                            borderRadius: BorderRadius.circular(10),
                                                                                            borderSide: const BorderSide(
                                                                                                width: 0.5, color: AppThemData.red500),
                                                                                          ),
                                                                                        )),
                                                                                    itemBuilder: (context, item, isDisabled, isSelected) {
                                                                                      return Padding(
                                                                            ...
                                                                            SizedBox(
                                                                              ...
                                                                              child: Obx(
                                                                                () => DropdownButtonFormField(
                                                                                  ...
                                                                                  onChanged: (String? statusType) {
                                                                                    controller.selectedFilterBookingStatus.value =
                                                                                        statusType ?? "All";
                                                                                    // controller.getBookingDataByBookingStatus();
                                                                                  },
                                                                                  value: controller.selectedFilterBookingStatus.value,
                                                                                  items: controller.bookingStatus
                                                                          ...
                                                                          : CustomButtonWidget(
                                                                              ...
                                                                              onPress: () {
                                                                                if (Constant.isDemo) {
                                                                                  ...
                                                                                  controller.downloadInterCityBookingPdf(context);
                                                                                }
                                                                              },
                                                                            ),
                                                                    )
                                          ...
                                          : controller.currentPageBooking.isEmpty
                                              ...
                                              : DataTable(
                                                  ...
                                                  rows: controller.currentPageBooking
                                                      .map((intercityModel) => DataRow(cells: [
                                                            DataCell(
                                                              TextCustom(
                                                                title:
                                                                    intercityModel.id!.isEmpty ? "N/A".tr : "#${intercityModel.id!.substring(0, 8)}",
                                                              ),
                                                            ),
                                                            DataCell(
                                                              FutureBuilder<UserModel?>(
                                                                  future: FireStoreUtils.getUserByUserID(
                                                                      intercityModel.customerId.toString()), // async work
                                                            ...
                                                            DataCell(TextCustom(
                                                                title: intercityModel.createAt == null
                                                                    ? ''
                                                                    : Constant.timestampToDateTime(intercityModel.createAt!))),
                                                            DataCell(TextCustom(
                                                                title:
                                                                    bool.parse(intercityModel.paymentStatus!.toString()) ? "Paid".tr : "Unpaid".tr)),
                                                            DataCell(
                                                              // e.bookingStatus.toString()
                                                              Constant.bookingStatusText(context, intercityModel.bookingStatus.toString()),
                                                            ),
                                                            // DataCell(TextCustom(title: Constant.amountShow(amount: bookingModel.subTotal))),
                                                            DataCell(TextCustom(
                                                                title: Constant.amountShow(
                                                                    amount: Constant.calculateInterCityFinalAmount(intercityModel).toString()))),
                                                            DataCell(
                                                              Container(
                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    InkWell(
                                                                      onTap: () async {
                                                                        // Get.toNamed(Routes.INTERCITY_DETAIL,
                                                                        //     arguments: {'bookingModel': intercityModel});
                                                                        Get.toNamed('${Routes.INTERCITY_DETAIL}/${intercityModel.id}');
                                                                    ...
                                                                    InkWell(
                                                                      onTap: () async {
                                                                        if (Constant.isDemo) {
                                                                          ...
                                                                          if (confirmDelete) {
                                                                            await controller.removeBooking(intercityModel);
                                                                            controller.getBookings();
                                                                          }
                                                                        }
                                                                      },
