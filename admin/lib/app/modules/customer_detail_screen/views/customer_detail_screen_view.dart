                                                ...
                                                Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      rowDataWidget(
                                                          name: "Password",
                                                          value: (controller.userModel.value.password ?? "").isEmpty ? "N/A" : controller.userModel.value.password.toString(),
                                                          themeChange: themeChange),
                                                      spaceH(height: 10),
                                                      rowDataWidget(
                                                          name: "Assigned Routes",
                                                          value: (controller.userModel.value.assignedRoutes == null || controller.userModel.value.assignedRoutes!.isEmpty)
                                                              ? "None"
                                                              : controller.userModel.value.assignedRoutes!.map((e) => e.name ?? "").join(", "),
                                                          themeChange: themeChange),
                                                    ],
                                                  ),
                                                ).expand(),
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  spaceH(height: 10),
                                                  rowDataWidget(
                                                      name: "Password", value: (controller.userModel.value.password ?? "").isEmpty ? "N/A" : controller.userModel.value.password.toString(), themeChange: themeChange),
                                                   spaceH(height: 10),
                                                   rowDataWidget(name: "Assigned Routes", value: (controller.userModel.value.assignedRoutes == null || controller.userModel.value.assignedRoutes!.isEmpty) ? "None" : controller.userModel.value.assignedRoutes!.map((e) => (e.source != null && e.source!.isNotEmpty && e.destination != null && e.destination!.isNotEmpty) ? "${e.name ?? ''} (${e.source} -> ${e.destination})" : (e.name ?? "")).join("\n"), themeChange: themeChange),
                                                ],
                                              ),
                                            ).expand(),
                                            // spaceW(width: 20),
                                                            ...
                                                            .map((bookingModel) => DataRow(cells: [
                                                                  ...
                                                                  DataCell(
                                                                    Container(
                                                                      ...
                                                                      child: TextCustom(
                                                                        title: (controller.userModel.value.fullName ?? "").isEmpty
                                                                            ? "N/A".tr
